...
>
> 🎉 **如果您是普通用户，想要直接使用 AI漫剧智能体，请前往主仓库下载完整客户端：**
>
> | 平台                                                                                                         | 链接                                                                            |
> | ------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
...
AI漫剧智能体 Web 提供了完整的短剧创作前端界面，包含以下核心模块：
...
| ---------------------------------------------- | -------------- | -------------------------------------------------------- | ------------------------------------------------------- |
| 🎬 **普通用户** - 想直接使用 AI漫剧智能体 创作短剧 | 下载完整客户端 | [Toonflow-app](https://github.com/HBAI-Ltd/Toonflow-app) | [Toonflow-app](https://gitee.com/HBAI-Ltd/Toonflow-app) |
...
- ✅ **后端服务**：确保 AI漫剧智能体 后端服务已启动并可访问（可从 [GitHub](https://github.com/HBAI-Ltd/Toonflow-app) 或 [Gitee](https://gitee.com/HBAI-Ltd/Toonflow-app) 获取）
...
<img src="./docs/chat6QR.jpg" alt="AI漫剧智能体 Logo" height="400"/>
...
📧 邮箱：[ltlctools@outlook.com](mailto:ltlctools@outlook.com?subject=AI漫剧智能体前端咨询)

---

# 📜 许可证

AI漫剧智能体 Web 基于 AGPL-3.0 协议开源发布，许可证详情：https://www.gnu.org/licenses/agpl-3.0.html

您可以在遵循 AGPL-3.0 相关条款与条件的情况下，将 AI漫剧智能体 Web 用于包括商业目的在内的各类用途。
